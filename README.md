...
directory for maintaining prediction-related history.

This allows the application to keep track of previously generated prediction information.
...
Prediction-related information can be maintained for later reference.
